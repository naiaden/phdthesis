...
\{\pgfkeysvalueof{/#1/min/#2},\pgfkeysvalueof{/#1/max/#2}\}:#3 
\ifnum\pgfkeysvalueof{/#1/min/#2}>\eval{round(#3)}%
\pgfkeys{/#1/min/#2 = \eval{round(#3)-0.5}}%
\fi%
\ifnum\pgfkeysvalueof{/#1/max/#2}<\eval{round(#3)}%
\pgfkeys{/#1/max/#2 = \eval{round(#3)+0.5}}
\fi%
\ptc{\eval{round(100*(((#3-\pgfkeysvalueof{/#1/min/#2}))/(\pgfkeysvalueof{/#1/max/#2}-\pgfkeysvalueof{/#1/min/#2})))}}%
\numprint{#3}
}

\pgfkeys{/obw/min/obw/.initial=1000}
\pgfkeys{/obw/max/obw/.initial=1}
\pgfkeys{/obw/min/emea/.initial=1000}
\pgfkeys{/obw/max/emea/.initial=1}
\pgfkeys{/obw/min/jrc/.initial=1000}
\pgfkeys{/obw/max/jrc/.initial=1}
\pgfkeys{/obw/min/wp/.initial=1000}
\pgfkeys{/obw/max/wp/.initial=1}

\pgfkeys{/emea/min/obw/.initial=1000}
\pgfkeys{/emea/max/obw/.initial=1}
\pgfkeys{/emea/min/emea/.initial=1000}
\pgfkeys{/emea/max/emea/.initial=1}
\pgfkeys{/emea/min/jrc/.initial=1000}
\pgfkeys{/emea/max/jrc/.initial=1}
\pgfkeys{/emea/min/wp/.initial=1000}
\pgfkeys{/emea/max/wp/.initial=1}

\pgfkeys{/jrc/min/obw/.initial=1000}
\pgfkeys{/jrc/max/obw/.initial=1}
\pgfkeys{/jrc/min/emea/.initial=1000}
\pgfkeys{/jrc/max/emea/.initial=1}
\pgfkeys{/jrc/min/jrc/.initial=1000}
\pgfkeys{/jrc/max/jrc/.initial=1}
\pgfkeys{/jrc/min/wp/.initial=1000}
\pgfkeys{/jrc/max/wp/.initial=1}
