...
In the original paper by \citep{Teh2006AHierarchical}, the functions\marginnote{Eq.~10 and 11 in the paper by \citeauthor{Teh2006AHierarchical}.} that return the word probability are defined as:
