...
For the experiments on English we use four corpora: two large generic mixed-domain corpora and two smaller domain-specific corpora. Although the two generic corpora comprise encyclopedic and news texts, we consider them less domain-specific.\footnote{waarom vinden we dit?}
 ...
 \subsection{\wp}
  ...
  We only use the English part of this parallel-aligned multilingual corpus. We shuffle the sentences and create a train (31 million words) and test split (8 million words). 
  ...
  %	\centering
  	\subfloat[\obw]{%\hspace*{-4em}
  		\begin{scaletikzpicturetowidth}{0.3*\textwidth}
  			...
  			xlabel=rank of word type in 1bw,
  			ylabel=frequency,
  			width=5cm, %0.5\textwidth,
  			legend cell align=left,
  			legend pos=outer north east,
  			legend style={draw=none}]
  			\addplot table [y=tr1val, x=tr1pos]{data/tr1.dat};
  			\addplot table [y=te1val, x=tr1pos]{data/tr1.dat};
  			%\addlegendentry{1-grams}
  			\addplot table [y=tejval, x=tr1pos]{data/tr1.dat};
  			%\addlegendentry{2-grams}
  			\addplot table [y=teeval, x=tr1pos]{data/tr1.dat};
  			\end{axis}
  			\end{tikzpicture}
  	...
  	\subfloat[\jrc]{ \begin{scaletikzpicturetowidth}{0.3*\textwidth}
  			...
  			ymode=log,
  			%title=lol,
  			%xlabel=relative position in document,
  			%  ylabel=types,
  			width=5cm,%0.5\textwidth,
  			legend cell align=left,
  			legend pos=outer north east,
  			legend style={draw=none}]
  			\addplot table [y=trjval, x=trjpos]{data/trj.dat};
  			\addplot table [y=te1val, x=trjpos]{data/trj.dat};
  			%\addlegendentry{1-grams}
  			\addplot table [y=tejval, x=trjpos]{data/trj.dat};
  			%\addlegendentry{2-grams}
  			\addplot table [y=teeval, x=trjpos]{data/trj.dat};
  			\end{axis}
  			\end{tikzpicture}
  	\end{scaletikzpicturetowidth}}%\qquad
  	\subfloat[\emea]{\begin{scaletikzpicturetowidth}{0.3*\textwidth}
  			...
  			legend pos=outer north east,
  			legend style={draw=none}]
  			\addplot table [y=treval, x=trepos]{data/tre.dat};
  			\addplot table [y=te1val, x=trepos]{data/tre.dat};
  			%\addlegendentry{1-grams}
  			\addplot table [y=tejval, x=trepos]{data/tre.dat};
  			%\addlegendentry{2-grams}
  			\addplot table [y=teeval, x=trepos]{data/tre.dat};
  			\end{axis}
  			\end{tikzpicture}
