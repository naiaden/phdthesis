...
\begin{table}%
    \centering
    \subfloat[Unigrams]{{\begin{tabular}{lllll}
     & \obw  & \emea & \jrc  & \wp   \\
\obw  & 1.5  & 10.9 & 6.2  & 6.6  \\
\emea & 18.3 & 0.1  & 10.1 & 22.4 \\
\jrc  & 12.3 & 14.9 & 0.4  & 9.9  \\
\end{tabular}\label{tab:ex1ample1} }}%
    \qquad
    \subfloat[Bigrams]{{\begin{tabular}{llll}
 \obw   & \emea & \jrc  & \wp \\
 17.82 & 4.13 & 5.34 &    \\
 1.28  & 8.37 & 1.19 &    \\
 3.51  & 2.46 & 9.81 &    \\
